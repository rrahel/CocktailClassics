 ...
 * and by clicking at a ingredient the user can delete it. After deleting the shopping list will refresh automatically.
 * @author Rrahel Cemi
 *
 */
public class CocktailShoppingDeleteZutaten extends DialogFragment implements
		OnItemClickListener {

	public static final String ARG_ITEM_ID = "Zutaten_Loschen_von_shopping_list";
	...
	public CocktailShoppingDeleteZutaten() {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		resDAO = new RessourceDAO(getActivity());
	 ...
	 * It removes the item from the shopping list 
	...
	public void onItemClick(AdapterView<?> list, View view, int position,
		...
		if (ingredient != null) {
			...
			CocktailShoppingFragment cocktailfrag = new CocktailShoppingFragment();

			FragmentManager fm = getActivity().getSupportFragmentManager();
			fm.beginTransaction().replace(R.id.content_frame, cocktailfrag)
					.commit();
		}
	}
}

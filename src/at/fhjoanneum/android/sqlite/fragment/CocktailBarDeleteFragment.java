...
/**
 * 
 * This fragment is responsible for displaying the resources that are currently in your bar. 
 * By tapping at one of the resources it gets removed automatically from the bar and the bar is automatically refreshed
 * 
 * @author Andreas Egger
 *
 */
public class CocktailBarDeleteFragment extends DialogFragment implements
		OnItemClickListener {

	public static final String ARG_ITEM_ID = "cocktail_bar_delete_fragment";
	...
	public CocktailBarDeleteFragment() {

	}
	
	/**
	 * In the following two methods the layout is attached to the fragment, variables get attached to the views and Listeners get set to the buttons
	 */
	@Override
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		ivIcon.setImageResource(R.drawable.ic_delete32);
	...
	/**
	 * In this class we define the task that is responsible for getting the list of resources out of the Database (via ressourceDAO.getInBarRessources())
	 * 
	 */
	public class GetRessourceTask extends
		...
		/**
		 * In this method we add the list of resources, that we received from the ressourceDAO, to the barListAdapter, which is than inserting it into the ListView items
		 */
		@Override
	...
	/**
	 * Here we set what happens, when an item is tapped. It gets removed from the bar and is removed from the current list.
	 */
	@Override
